...
# haic launcher for the Qwen3-VL reward model.
# Same cluster detection as train_qwen.sh so paths resolve correctly
# whether this is run via sbatch on haic, bash on haic, or copied to iris.
