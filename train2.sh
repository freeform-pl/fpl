...
export WANDB_DIR=/scr/marcelto/wandb
export WANDB_CACHE_DIR=/scr/marcelto/wandb_cache
mkdir -p /scr/marcelto/wandb /scr/marcelto/wandb_cache
...
# setup table
# python main.py --stride 20 --seq_len 20 --img_size 128 --batch_size 64 --epochs 1000 --embed_dim 128 --vis_interval 50 --log_interval 1 --save_interval 50 --preferences_dir /iris/u/am208/droid-robot/preferences_setup --cross_preferences_dir /iris/u/abhijnya/droid-robot/cross_preferences_setup,/iris/u/am208/droid-robot/cross_preferences_setup --preload --task setup_table --preload_offsets 10 --only_large
# python main.py --stride 20 --seq_len 20 --img_size 256 --batch_size 64 --epochs 1000 --embed_dim 256 --vis_interval 50 --log_interval 1 --save_interval 50 --preferences_dir /iris/u/am208/droid-robot/preferences_setup --cross_preferences_dir /iris/u/abhijnya/droid-robot/cross_preferences_setup,/iris/u/am208/droid-robot/cross_preferences_setup --preload --task setup_table --preload_offsets 10
python main.py --stride 20 --seq_len 20 --img_size 128 --batch_size 64 --epochs 1000 --embed_dim 128 --vis_interval 50 --log_interval 1 --save_interval 100 --preferences_dir /iris/u/am208/droid-robot/preferences_setup --cross_preferences_dir /iris/u/abhijnya/droid-robot/cross_preferences_setup,/iris/u/am208/droid-robot/cross_preferences_setup --preload --task setup_table --preload_offsets 10
# python main.py --stride 20 --seq_len 20 --img_size 128 --batch_size 64 --epochs 1000 --embed_dim 128 --vis_interval 50 --log_interval 1 --save_interval 100 --preferences_dir /iris/u/am208/droid-robot/preferences_setup --cross_preferences_dir /iris/u/abhijnya/droid-robot/cross_preferences_setup,/iris/u/am208/droid-robot/cross_preferences_setup --preload --task single --preload_offsets 10
