...
# python train.py --config-name=train_diffusion_transformer_lowdim_workspace.yaml task=square_lowdim task.dataset.max_train_episodes=50 task.dataset_type=mh
python train.py --config-name=train_diffusion_transformer_lowdim_workspace.yaml task=square_lowdim task.dataset_type=mh