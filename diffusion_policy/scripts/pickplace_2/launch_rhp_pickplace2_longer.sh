...
export PIPELINE_DIR="pipeline_output_pickplace_2obj_fixed_rhp_2k"
export WANDB_PROJECT="pickplace_2obj_fixed_rhp"
# Training-duration ablation: 2000 epochs (vs RHP default 750).
export BASE_POLICY_DIR="base_policy_pickplace_2obj_fixed_v2"
