...
export PIPELINE_DIR="pipeline_output_pickplace_2obj_fixed_rhp_bs512"
export WANDB_PROJECT="pickplace_2obj_fixed_rhp"
# Batch-size ablation: batch=512 (vs RHP default 1024).
# LR linearly scaled: 2e-4 * (512/1024) = 1e-4 to keep gradient noise comparable.
