...
export PIPELINE_DIR="pipeline_output_pickplace_2obj_fixed_rhp_aug03"
export WANDB_PROJECT="pickplace_2obj_fixed_rhp"
# Augment-score ablation: AUGMENT_SCORE=0.3 (vs RHP default 0.1).
