...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --job-name=pp2_rhp_bs256_2k
...
export PIPELINE_DIR="pipeline_output_pickplace_2obj_fixed_rhp_bs256_2k"
export WANDB_PROJECT="pickplace_2obj_fixed_rhp"
# Batch-size ablation: batch=256 (vs RHP default 1024), trained for 2000 epochs.
