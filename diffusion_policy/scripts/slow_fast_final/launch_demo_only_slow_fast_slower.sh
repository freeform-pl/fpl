...
export PIPELINE_DIR="pipeline_output_slow_fast_final_demo_only_slower"
export WANDB_PROJECT="slow_fast_final_demo_only"
...
# pickplace_2_final demo_only which also uses the YAML defaults.
