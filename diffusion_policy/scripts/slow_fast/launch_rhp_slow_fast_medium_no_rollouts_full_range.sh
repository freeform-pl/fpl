...
# RHP baseline for slow/fast MEDIUM — no rollouts, 200 scripted demos
# Both pegs sample speed uniformly from [1, 4]
export PIPELINE_DIR="pipeline_output_slow_fast_medium_no_rollouts_full_range_rhp"
export WANDB_PROJECT="slow_fast_medium_no_rollouts_full_range_rhp"
