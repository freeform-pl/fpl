...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --job-name=sprf_sf_lp
#SBATCH --nodelist=iris7,iris8,iris10
#SBATCH --output slurm/%j.out

# Single-pref baseline for slow/fast — less preferences (100 pairs)
export PIPELINE_DIR="pipeline_output_slow_fast_less_preferences_single_pref"
export WANDB_PROJECT="slow_fast_less_preferences_single_pref"
