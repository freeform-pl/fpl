...
export PIPELINE_DIR="pipeline_output_slow_fast_medium_no_rollouts_mid_range_discrete_demo_only"
export WANDB_PROJECT="slow_fast_medium_no_rollouts_mid_range_discrete_demo_only"
