...
export PIPELINE_DIR="pipeline_output_slow_fast_medium_no_rollouts_mid_range_discrete_rhp"
export WANDB_PROJECT="slow_fast_medium_no_rollouts_mid_range_discrete_rhp"
...
export EVAL_Z_NEGATIVE="[0.5,0.9]"
