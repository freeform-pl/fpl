...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --job-name=rhp_sf_mid_bigbs
#SBATCH --nodelist=iris7,iris8,iris10
#SBATCH --output slurm/%j.out

# Same as mid_range_discrete but with bigger network + batch size 1024
export PIPELINE_DIR="pipeline_output_slow_fast_medium_no_rollouts_mid_range_discrete_bigbs_rhp"
export WANDB_PROJECT="slow_fast_medium_no_rollouts_mid_range_discrete_bigbs_rhp"
...
export EXTRA_POLICY_OVERRIDES="++policy.model.n_layer=12 ++policy.model.n_emb=512 ++policy.model.n_head=8 ++dataloader.batch_size=1024 ++val_dataloader.batch_size=1024"
