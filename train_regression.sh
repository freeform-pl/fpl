...
python main.py --stride 10 --seq_len 20 --img_size 128 --batch_size 64 --epochs 2000 --embed_dim 128 --vis_interval 10 --log_interval 1 --save_interval 10 --preferences_dir preferences_2026_04_11,preferences_2026_04_14 --regression --preload
