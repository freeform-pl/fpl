...
python main.py --stride 10 --seq_len 20 --img_size 128 --batch_size 64 --epochs 1000 --embed_dim 128 --vis_interval 10 --log_interval 1 --save_interval 50 --preferences_dir preferences_04_11to22,preferences_2026_04_14 --model discounted --freeze_backbone
