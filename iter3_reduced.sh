...
RUN_TAG=${WANDB_PROJ}_${ITER}_iter3_reduced
TASK=setup_table_reduced
OUTPUT_SUBDIR=${TASK}_iter3_multi_qwen
DECIMAL_PLACES=1
ITER_TAG=iter3_${ITER}
...
RUN_TAG=${WANDB_PROJ}_${ITER}_iter3_reduced
TASK=setup_table_reduced
OUTPUT_SUBDIR=${TASK}_iter3_single_qwen
DECIMAL_PLACES=1
ITER_TAG=iter3_${ITER}
TASK_PROMPT="set up the table"
...
python infer.py \
    --ckpt "$CKPT" \
    --preferences_dir "${DATA_AM208}/preferences_setup,${DATA_AM208}/demos/setup" \
